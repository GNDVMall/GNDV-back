...
public interface OrderMapper {
    ...
    @Results({
            ...
            @Result(property = "buyer", column = "buyer_id", one = @One(select = "com.iamportpractice.mapper.MemberMapper.findById")),
            @Result(property = "seller", column = "seller_id", one = @One(select = "com.iamportpractice.mapper.MemberMapper.findById")),
            @Result(property = "payment", column = "payment_id", one = @One(select = "com.iamportpractice.mapper.PaymentMapper.findById"))
    })
