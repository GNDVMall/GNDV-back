...
public interface ChatSocketMapper {
    @Insert("INSERT INTO Chat_Message (chat_content,member_id ,chatroom_id, message_user_type, content_type) " +
            "VALUES (#{content},(SELECT member_id FROM Member WHERE email = #{email}),#{chatroom_id}, #{message_user_type}, #{content_type})")
