...
public class ChatService {
    ...
    @Transactional
    public List<ChatMessage> getChatRoomMessages(Long chatrooom_id, String email) {
        List<ChatMessage> messages = chatMapper.findAllMessagesByIdAndUpdateIsRead(chatrooom_id, email);
        return messages;
    }
}
